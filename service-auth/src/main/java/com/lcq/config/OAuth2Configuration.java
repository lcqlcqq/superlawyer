...
public class OAuth2Configuration extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients
                ...
                .withClient("lawyer-web")   //客户端名称，随便起就行
                .secret(encoder.encode("654321"))      //只与客户端分享的secret，随便写，但是注意要加密
                .autoApprove(false)    //自动审批，这里关闭，要的就是一会体验那种感觉
                .scopes("project", "user", "service","verify")     //授权范围，这里我们使用全部all
                .redirectUris("http://localhost:32010/login", "http://localhost:32020/login",
                        "http://localhost:32030/login","http://localhost:32040/login")
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
        endpoints
                .tokenServices(serverTokenServices())   //JWT service
                .userDetailsService(service)
